...
export default function MaintenancePage() {
  ...
  useEffect(() => {
    // Fetch maintenance status from Edge Config
    const fetchMaintenanceStatus = async () => {
      try {
        ...
        if (data.liveTime) {
          const targetTime = new Date(data.liveTime).getTime();
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-zinc-50 dark:bg-black">
        <div className="text-center">
          <div className="mb-4 h-8 w-8 animate-spin rounded-full border-4 border-zinc-300 border-t-zinc-600 mx-auto"></div>
      ...
      <div className="mx-auto max-w-2xl px-6 py-16 text-center">
        <div className="mb-8">
          ...
          <p className="text-xl text-zinc-600 dark:text-zinc-400">
            {maintenanceData.indefiniteMaintenance || !maintenanceData.liveTime
        ...
        {maintenanceData.indefiniteMaintenance && (
